// config.bin - 09:30:29 11/14/12, generated in 0.22 seconds
...
class CfgVehicles {
	...
	class epic_beard_man; // External class reference
	class dimitry; // External class reference
	...
	class Stanislav_DZ : Stained_Stanislav {
	...
	class Silvestr_DZ : Scabby_Silvestr {
	...
	class SurvivorW2_DZ : BB_Merc_OA_Female_pilot2 {
